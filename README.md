...
<img src="https://latex.codecogs.com/svg.latex?\Large&space;r=\tau\cdot\sqrt{\frac{|M|}{\pi}}" title="\Large r=\tau\cdot\sqrt{\frac{|M|}{\pi}}" HEIGHT="24"> where <I>|M|</I> is the area of the mesh.
